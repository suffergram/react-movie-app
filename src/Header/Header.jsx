...
export default function Header({ newModal, isMovieInfoOpen, onCloseMovieInfo, movieId }) {
    const handleClick = () => {
        newModal('add')
    }
    ...
    return (
        <header>
            ...
            {isMovieInfoOpen ? <MovieInfo movieId={movieId} onCloseMovieInfo={onCloseMovieInfo} /> : null}
        </header>
    );
}